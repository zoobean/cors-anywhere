...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://beanstack.com', 'https://beanstack.org'],            // If non-empty, requests not from an origin in this list will be blocked.
    ...
    noLocation: __dirname + 'no-location.txt',
  ...
  return function(req, res) {
    ...
    if (!location) {
      ...
      showUsage(corsAnywhere.noLocation, cors_headers, res);
      return;
    }
